...
import com.covid.vaccination.Implementation.VaccineStorageServiceImpl;
...
public class AdminController {
    ...
    @Autowired
    public VaccineStorageServiceImpl vaccinStore;
...
//    get User Using User_id
    ...
    @PostMapping("/Admin/vaccineAllocationToCenter")
    public VaccineStorage createUser(@RequestBody VaccineStorage vaccineStorage) {
        vaccinStore.save(vaccineStorage);
